          ...
          <div id="menu-2" className={`hidden md:flex md:ml-auto flex-row items-start mt-[7px]`}>
            ...
            {!account ? (
              <button
                ...
                className={`flex flex-row items-center py-[12px] px-[25px] text-[17px] leading-[27px] rounded-[11px] border border-white text-black bg-white hover:border-slate-200 hover:bg-slate-200`}
              >
              <WalletIcon />
